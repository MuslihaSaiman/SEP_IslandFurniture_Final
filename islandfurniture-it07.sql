...
CREATE TABLE `accessrightentity` (
  ...
  `MANUFACTURINGFACILITY_ID` bigint DEFAULT NULL,
  `REGIONALOFFICE_ID` bigint DEFAULT NULL,
...
CREATE TABLE `billofmaterialentity_lineitementity` (
  `BillOfMaterialEntity_ID` bigint NOT NULL,
  `listOfLineItems_ID` bigint NOT NULL,
...
CREATE TABLE `combolineitementity` (
  ...
  `MENUITEM_ID` bigint DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `country_ecommerce` (
  `CountryEntity_ID` bigint NOT NULL,
  `WarehouseEntity_ID` bigint NOT NULL,
  PRIMARY KEY (`CountryEntity_ID`,`WarehouseEntity_ID`),
  KEY `WarehouseEntity_ID_idx` (`WarehouseEntity_ID`),
  CONSTRAINT `CountryEntity_ID` FOREIGN KEY (`CountryEntity_ID`) REFERENCES `countryentity` (`ID`),
  CONSTRAINT `WarehouseEntity_ID` FOREIGN KEY (`WarehouseEntity_ID`) REFERENCES `warehouseentity` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `country_ecommerce` VALUES (25,55);
...
CREATE TABLE `deliverydetailsentity` (
  ...
  `SALERECORD_ID` bigint DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `masterproductionscheduleentity` (
  `ID` bigint NOT NULL,
  `AMOUNT_MONTH` int DEFAULT NULL,
  `AMOUNT_WEEK1` int DEFAULT NULL,
  `AMOUNT_WEEK2` int DEFAULT NULL,
  `AMOUNT_WEEK3` int DEFAULT NULL,
  `AMOUNT_WEEK4` int DEFAULT NULL,
  `AMOUNT_WEEK5` int DEFAULT NULL,
  `MENUITEM_ID` bigint DEFAULT NULL,
  `MF_ID` bigint DEFAULT NULL,
  `STORE_ID` bigint DEFAULT NULL,
  `FURNITURE_ID` bigint DEFAULT NULL,
...
CREATE TABLE `materialrequiremententity` (
  ...
  `QUANTITY` int DEFAULT NULL,
  `MF_ID` bigint DEFAULT NULL,
  `MPS_ID` bigint DEFAULT NULL,
  `RAWINGREDIENT_ID` bigint DEFAULT NULL,
...
CREATE TABLE `memberentity` (
  ...
  `ZIPCODE` longtext,
  `LOYALTYTIER_ID` bigint DEFAULT NULL,
  `COUNTRY_ID` bigint DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=12074 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `memberentity_lineitementity` (
  `MemberEntity_ID` bigint NOT NULL,
...
CREATE TABLE `messageentity` (
  ...
  `MESSAGEOWNER_ID` bigint DEFAULT NULL,
...
CREATE TABLE `messageentity_staffentity` (
  `MessageEntity_ID` bigint NOT NULL,
  `receivers_ID` bigint NOT NULL,
...
CREATE TABLE `monthscheduleentity` (
  ...
  `WORKDAYS_FIFTHWEEK` int DEFAULT NULL,
  `WORKDAYS_FIRSTWEEK` int DEFAULT NULL,
  `WORKDAYS_FORTHWEEK` int DEFAULT NULL,
  `WORKDAYS_SECONDWEEK` int DEFAULT NULL,
  `WORKDAYS_THIRDWEEK` int DEFAULT NULL,
...
CREATE TABLE `pickrequestentity_lineitementity` (
  `PickRequestEntity_ID` bigint NOT NULL,
...
CREATE TABLE `productgrouplineitementity` (
  ...
  `ITEM_ID` bigint DEFAULT NULL,
  `PRODUCTGROUP_ID` bigint DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
INSERT INTO `purchaseorderentity` VALUES (9852,'2014-11-11 07:50:47','2014-11-10','Completed','Neo Wei',6252,8904),(9853,'2019-01-21 15:23:50','2019-01-25','Unfulfillable','Administrator',55,66),(9854,'2019-01-21 23:15:27','2019-01-24','Shipped','Administrator',60,8251),(9855,'2019-01-21 23:17:44','2019-02-02','Pending','Administrator',55,66),(9856,'2019-01-22 08:57:02','2019-01-26','Completed','Administrator',10002,8252),(9857,'2019-01-22 12:30:18','2019-01-30','Completed','Administrator',6252,67);
...
CREATE TABLE `purchaseorderentity_lineitementity` (
  `PurchaseOrderEntity_ID` bigint NOT NULL,
  `lineItems_ID` bigint NOT NULL,
...
INSERT INTO `purchaseorderentity_lineitementity` VALUES (9852,9854),(9852,12049),(9854,12051),(9854,12057),(9856,12058),(9857,12073),(9855,12081),(9855,12082);
...
CREATE TABLE `recipeentity_lineitementity` (
  `RecipeEntity_ID` bigint NOT NULL,
  `listOfLineItems_ID` bigint NOT NULL,
...
CREATE TABLE `saleandoperationplanentity` (
  `ID` bigint NOT NULL,
  `CURRENTINVENTORYLEVEL` int DEFAULT NULL,
  `MONTH` int DEFAULT NULL,
  `PRODUCTIONPLAN` int DEFAULT NULL,
  `SALEFORCASTDATA` int DEFAULT NULL,
  `TARGETINVENTORYLEVEL` int DEFAULT NULL,
  `YEAR` int DEFAULT NULL,
  `MANUFACTURINGFACILITY_ID` bigint DEFAULT NULL,
  `PRODUCTGROUP_ID` bigint DEFAULT NULL,
  `SCHEDULE_ID` bigint DEFAULT NULL,
  `STORE_ID` bigint DEFAULT NULL,
  `SALEFORCAST_ID` bigint DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `salesfigurelineitementity` (
  ...
  `SALEFIGURE_ID` bigint DEFAULT NULL,
  PRIMARY KEY (`ID`),
...
CREATE TABLE `salesrecordentity` (
  ...
  `LOYALTYPOINTSDEDUCTED` int DEFAULT NULL,
...
CREATE TABLE `salesrecordentity_lineitementity` (
  `SalesRecordEntity_ID` bigint NOT NULL,
  `itemsPurchased_ID` bigint NOT NULL,
...
INSERT INTO `sequence` VALUES ('SEQ_GEN',12100);
...
INSERT INTO `shippingorderentity` VALUES (8954,'2014-11-10 19:16:51','2014-11-10',NULL,'2014-11-10','Completed','Yang Lusi',58,55),(9951,'2014-11-12 05:08:03','2014-11-11',NULL,'2014-11-12','Completed','Tan Wee Kek',58,55),(9952,'2019-01-22 15:55:05','2019-01-26',NULL,NULL,'Unfulfillable','Administrator',1751,55),(9953,'2019-01-23 08:47:16','2019-01-30',NULL,NULL,'Completed','Administrator',10002,55),(9954,'2019-01-23 12:17:21','2019-01-24',NULL,'2019-01-23','Shipped','Administrator',6251,55),(9956,'2019-01-23 14:21:38','2019-02-02',NULL,NULL,'Pending','Administrator',1751,6251);
...
CREATE TABLE `shippingorderentity_lineitementity` (
  `ShippingOrderEntity_ID` bigint NOT NULL,
  `lineItems_ID` bigint NOT NULL,
...
INSERT INTO `shippingorderentity_lineitementity` VALUES (8954,8955),(8954,8956),(8954,8957),(8954,8959),(9951,9952),(9952,12075),(9953,12076),(9954,12077),(9956,12084);
...
CREATE TABLE `staffentity` (
  ...
  `INVALIDLOGINATTEMPT` int DEFAULT NULL,
  `NAME` longtext,
  `PASSWORDHASH` varchar(255) DEFAULT NULL,
  `PASSWORDRESET` varchar(255) DEFAULT NULL,
  `PHONE` longtext,
...
CREATE TABLE `staffentity_messageinboxentity` (
  `StaffEntity_ID` bigint NOT NULL,
  `inboxMessages_ID` bigint NOT NULL,
...
CREATE TABLE `storagebinentity_lineitementity` (
  `StorageBinEntity_ID` bigint NOT NULL,
  `lineItems_ID` bigint NOT NULL,
...
INSERT INTO `storagebinentity_lineitementity` VALUES (6,8851),(7,8852),(8,8855),(10,8902),(11,8903),(13,9003),(14,9006),(15,9009),(9,9773),(9,9774),(17,9903),(16,9956),(21,10056),(20,10151),(20,10152),(20,10153),(20,10154),(20,10155),(20,10156),(20,10157),(20,10158),(20,10159),(20,10160),(20,10161),(20,10162),(20,12072),(18,12074);
...
CREATE TABLE `store_manufacturingfacility` (
  ...
  `manufacturingFacilityList_ID` bigint NOT NULL,
...
INSERT INTO `subscriptionentity` VALUES (10251,'in 100 countries use ',NULL),(10301,'',NULL),(11552,'',NULL),(11651,'',NULL),(11901,'',NULL);
...
CREATE TABLE `transferorderentity` (
  ...
  `SUBMITTEDBY` varchar(255) DEFAULT NULL,
  `WAREHOUSE_ID` bigint DEFAULT NULL,
  `LINEITEM_ID` bigint DEFAULT NULL,
  `ORIGIN_ID` bigint DEFAULT NULL,
...
INSERT INTO `wishlistentity` VALUES (21),(23),(8352),(8354),(10052),(10102),(10104),(10202),(10352),(10402),(10452),(10502),(10552),(10652),(10702),(10752),(10802),(10852),(10902),(10952),(11002),(11052),(11102),(11152),(11202),(11252),(11254),(11302),(11352),(11402),(11452),(11502),(11602),(11802),(11952),(12002),(12004),(12053);
...
CREATE TABLE `wishlistentity_itementity` (
  `WishListEntity_ID` bigint NOT NULL,
  `items_ID` bigint NOT NULL,
...
-- Dump completed on 2023-07-09 23:07:21
